...
/*
THIS IS A COPY PASTED CLASS.
this is a copy of maybe the most used class, FlxSprite.
this was made to make it so ClientPrefs could force off antialiasing.
*/
...
class FlxSprite extends FlxObject
{
	...
	{
		return antialiasing = (ClientPrefs.antialiasing && value);
	}
